...
masterMaterialStacked = AssetTools.create_asset("M_Master_Stacked", "/Game/Materials/Masters", unreal.Material, unreal.MaterialFactoryNew())

#2D Texture Param and Connect to Base Color
baseColorTextureParam = MaterialEditLibrary.create_material_expression(masterMaterialStacked, unreal.MaterialExpressionTextureSampleParameter, -384, -300)
...
normalTextureParam = MaterialEditLibrary.create_material_expression(masterMaterialStacked, unreal.MaterialExpressionTextureSampleParameter, -384, -200)
...
ormTextureParam = MaterialEditLibrary.create_material_expression(masterMaterialStacked, unreal.MaterialExpressionTextureSampleParameter, -384, 100)
...
stackedMatInstance = AssetTools.create_asset("masterMatStacked_ORM_Inst", "/Game/Materials/Masters", unreal.MaterialInstanceConstant, unreal.MaterialInstanceConstantFactoryNew())
#stackedMatInstance.set_editor_property(unreal.MaterialInstanceConstant.parent == stackedMatInstance, 0)

EditorAssetLibrary.save_asset("/Game/Materials/Masters/M_Master_Stacked", True)
EditorAssetLibrary.save_asset("Game/Materials/Masters/masterMatStacked_ORM_Inst", True)
